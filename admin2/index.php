...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
            <img src="../img/tindware.png" alt="" width="24" height="24" class="d-inline-block align-text-top">
        TindWare
        </a>
            ...
            <form class="d-flex" action="buscar.php" method="POST" style="align-items: stretch;">
                ...
                <div class="me-1"><button data-bs-toggle="tooltip" data-bs-placement="bottom" title="Volver" class="btn btn-danger"><a href="../"><span class="iconify" data-icon="typcn:arrow-back" style="color: #ffffff;" data-width="24"></span></a></button></div>
            </form>
...
<script type="text/javascript">
        ...
        var element = document.getElementById(paginas[path])
        element.classList.add("active")

        // Activamos tooltips bootstrap
